...
int main(void)
{
	...
	// Load the texture
	GLuint Texture = loadBMP_custom("resources/teste.bmp");
	if (Texture == 0)
	{
	...
	do
	{
		...
		glUniform3f(glGetUniformLocation(programID, "lightPos"), xAxis, yAxis +1.0f, zAxis -1.0f);
		...
		Model = glm::translate(Model, glm::vec3(xAxis, yAxis, zAxis));
		...
		Model4 = glm::translate(Model4, glm::vec3(xAxis3,yAxis3, zAxis3));
